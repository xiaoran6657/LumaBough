...
- F 完成（2026-09-22）：三个账号名处置键按所有者明确授权批准（真实时间晚于转公开，未回填）；发布记录同步为 public 状态与按 ref 的文件数（tag 772 / main 774）；最终提交复跑 entry 与 candidate 均 PASS（仅保留读者延后提示），扫描 144 项、0 未裁定、0 待批准
